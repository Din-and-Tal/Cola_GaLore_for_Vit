...
def get_optimizer_scheduler(model, cfg):
    ...
    if "galore" in cfg.optimizer_name.lower():
        ...
        for module_name, module in model.named_modules():
            ...
            elif isinstance(module, ColaLinear):
                # ColaLinear uses down.cola_a and up.cola_b instead of a single weight
                galore_params.append(module.down.cola_a)
                galore_params.append(module.up.cola_b)
    ...
    if cfg.optimizer_name == "adamw":
        ...
        return None, None, optimizer_dict
    ...
    scheduler = CosineAnnealingWarmupRestarts(
        optimizer=optimizer,
        first_cycle_steps=cfg.total_steps,
        cycle_mult=cfg.scheduler_cycle_mult,
        max_lr=cfg.scheduler_max_lr,
        min_lr=cfg.scheduler_min_lr,
